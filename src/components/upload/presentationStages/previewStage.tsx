    ...
    >
      <div className="w-full h-fit gridPreview overflow-x-auto">
        <div className="w-full flex flex-col justify-between bg-[#FFFFF0]">
          {/* MARK: Preview */}
          <div className="maxScreenMobile:mt-4 w-[95%] maxScreenMobile:w-full m-auto h-[20rem] bg-white rounded-md border-2 border-primaryTwo maxScreenMobile:border-[0.1px] maxScreenMobile:border-primaryTwo maxScreenMobile:rounded-none">
            {processingFile ? (
              <div className="w-full h-full flex flex-col justify-center items-center">
                <LoadingAssetBig />
                <p className="text-primaryTwo">
          ...
          <div className="bg-[#ffa500] h-fit mt-16 pb-4 w-full">
            <p className="w-fit m-auto pt-14 pb-4 text-primaryTwo text-[1.2rem]">
              PRESENTER&apos;S INFORMATION
            </p>
            <div className="w-[95%] maxScreenMobile:w-full m-auto min-h-64 bg-[#FFFFF0] text-primaryTwo">
              <ul className="block w-full py-4">
                <li className="block w-full mb-4 px-4">
                  <span>Name</span>
                  <hr className="p-[0.8px] mt-1 bg-primaryTwo w-[80%] maxScreenMobile:w-full" />
        ...
        <div className="w-full bg-[#ffa500] pb-[1.7rem] flex flex-col justify-between">
          <p className="w-fit m-auto pt-14 pb-4 text-primaryTwo text-[1.2rem] mt-0">
            PRESENTATION DETAILS
          </p>
          <div className="w-[95%] maxScreenMobile:w-full m-auto mb-0 min-h-[calc(100%-(5.7rem))] _overflow-auto bg-[#FFFFF0] text-primaryTwo">
            ...
            <p className="bg-[#ffa500] text-primaryTwo w-3/6 pl-4 py-2 mb-4">
              SCHEDULE
            </p>
