...
export default function CoursePreviewPage() {
    return (<>
        ...
        <section className="bg-primaryTwo min-h-[30vh]">
            <h2 className="container text-3xl maxScreenMobile:text-2xl font-small uppercase text-white pt-10 pb-4">Courses in this Program</h2>
            {/* start */}
                ...
                <div key={idx} className="container !pb-4">
                    <AccordionWrapper
                        ...
                        title={<p className="w-full px-6 py-4 bg-[#FFFFF0] border-0 !rounded-md !font-normal">
                            <span className="block w-fit text-[#FFA500] text- mb-1 uppercase">Course 1-47 minutes</span>
        ...
        <section className="bg-primaryTwo w-full py-6">
            <h3 className="container text-3xl maxScreenMobile:text-2xl _text-center font-small pb-4 uppercase">Your Course Instructor</h3>
