  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`card rounded-lg p-4 maxScreenMobile:p-2 cursor-pointer aspect-[1/1.2] md:aspect-square border _border-[rgba(255,166,0,0.53)] ${border} ${!isDark && "primarySeven"} _border-slate-200`}
      >
