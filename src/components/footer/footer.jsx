  ...
  return (
    ...
    >
      <div className="container">
          ...
          <div className="footerrft w-3/5 flex justify-between align-top maxScreenMobile:flex-col maxScreenMobile:w-full">
            <div>
              ...
              <nav className="flex flex-col justify-between align-top">
                <Link
                  to={HOME}
                  className="block text-[0.9rem] py-2 relative before:block before:absolute before:top-auto before:bottom-1 before:left-0 before:right-0 before:h-0 before:!w-full before:py-[.1px] before:bg-black before:scale-x-0 !transition-all !ease-in-out !duration-300 hover:before:!scale-x-[1]"
                >
                  Home
                </Link>
                <NavLink
                ...
                <NavLink
                  to={"/signin"}
                  className={`block !text-[0.9rem] ${user && "hidden"} py-2 relative before:block before:absolute before:top-auto before:bottom-1 before:left-0 before:right-0 before:h-0 before:!w-full before:py-[.1px] before:bg-black before:scale-x-0 !transition-all !ease-in-out !duration-300 hover:before:!scale-x-[1]`}
                >
                  Sign In
                </NavLink>
                <NavLink
        ...
        <p
          className={`py-5 text-center border-t-[1px] ${pathname === "/" ? "border-black" : "border-white"} border-solid text-[0.9rem]`}
        >
