    ...
    <CourseOverviewRoot>
      <div className="wrapper w-full h-full grid grid-cols-1 grid-rows-[1fr_1fr] gap-2">
        ...
        <div className="analyticsOverviewBottom w-full h-full grid grid-cols-[400px_1fr] grid-rows-1 gap-2">
          ...
          <div className="w-full h-full border-none rounded-sm bg-gradient-to-b from-primarySixTwo_ from-slate-200 to-primaryTwo p-4 grid grid-cols-1 grid-rows-[auto_1fr_auto] gap-2">
