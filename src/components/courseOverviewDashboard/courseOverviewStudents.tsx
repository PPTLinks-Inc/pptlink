...
export default function CourseOverviewStudents() {
  ...
  return (
    <CourseOverviewRoot>
      ...
      {currentView === 2 && (
        <div className="wrapper w-full h-full grid grid-rows-[auto_1fr] grid-cols-1 gap-2">
          ...
          <p className="text-primarySixTwo text-sm font-semibold px-4">
            Sessions Attended
          </p>
          <div className="w-[97%] mx-auto h-full relative grid grid-rows-[auto_1fr] grid-cols-1 px-4 rounded-sm !border-[0.1px] border-white">
