...
>(({ className, isDark, isBorder, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        `flex flex-1 items-center justify-between ${isBorder && "py-6"} text-xl font-medium transition-all _hover:underline [&[data-state=open]>svg]:rotate-180 relative`,
        className
      )}
      {...props}
    >
