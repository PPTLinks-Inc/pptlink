    ...
    return (<>
        <section className={`relative ${currentView == 3 ? "before:bg-[#FFFFF0] text-black" : "bg-black"}`}>
            <div className="container h-fit py-10 flex flex-col justify-between items-center">
                <h1 className="text-5xl font-[400] uppercase mb-5 maxScreenMobile:text-3xl maxScreenMobile:text-center">UPLOADS</h1>
        ...
        <section className={`py-5 h-fit ${currentView == 3 ? "bg-[#FFFFF0] text-black" : "bg-black text-white"}`}>
            <div className={`${currentView == 3 ? "bg-[#FFFFF0] container" : "bg-black"} h-fit flex justify-evenly items-center border-b-2 ${currentView === 3 ? "border-b-black" : "border-b-white"}`}>
