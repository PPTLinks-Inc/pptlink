      ...
      <section className="bg-black">
        <div className="container min-h-fit py-10 flex flex-col justify-between items-center">
          ...
          <p className="text-center w-[80%] text-[0.8rem] mb-10">
            ...
            dola consequuntur quam quod voluptatum veritatis neque doloremque
            eligendi, qui exercitationem, quo saepe porro et deserunt id nobis
            quos corporis modi?
          </p>
        ...
        <div className="flex flex-wrap justify-between items-center gap-y-16 gap-x-8 w-full mt-20 mb-10">
          {Array(6)
            ...
            .map(({ id }) => (
              <div
                key={id}
                className="basis-[300px] grow-[1] min-h-[250px] bg-[#ffffff36] border border-[#FFA500] text-black rounded-md p-3 _text-center text-[.8rem] flex flex-col justify-between items-center"
              >
