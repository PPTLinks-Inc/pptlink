...
export default function NewHome() {
    ...
    return (
        <section className="parent_page_wrapper min-h-screen w-full">
            <div className="banner relative w-full min-h-screen text-white">
                <div className="container h-full text-center">
                    <div className="flex flex-col justify-between items-center pt-[4rem]">
                        <h1 className="text-[4rem] mb-5 maxScreenMobile:text-4xl">GET PRESENTABLE</h1>
                        <p className="w-3/5 text-sm leading-6 text-center mb-10 maxScreenMobile:w-full maxScreenMobile:">Lorem ipsum dolor sit amet,
                        ...
                        <div className="banner_btns w-3/5 mx-[auto] flex justify-between items-center maxScreenMobile:w-full maxScreenMobile:flex-col">
                            <button className="block w-2/5 bg-[white] text-black text-2xl p-2 rounded-[2rem] maxScreenMobile:w-full maxScreenMobile:mb-3">Present</button>
                            <button className="block w-2/5 bg-[white] text-black text-2xl p-2 rounded-[2rem] maxScreenMobile:w-full maxScreenMobile:mb-3">Libraries</button>
                        </div>
                    </div>
            ...
            <div className="recent relative w-full min-h-screen min-h-[100svh] text-white text-justify pb-10">
                <div className="container">
                    ...
                    <div className="cards_wrapper w-full mt-20 mb-10">
                        {Array(5).fill(0).map((_, i) => ({ id: i })).map(({ id }) =>
                ...
                border-solid border-black">
                        ...
                        <div className="rounded_animation absolute top-[-80px] left-[50%] translate-x-[-50%] bg-[#FFFFF0] w-[200px] h-[200px] rounded-[100px] p-3 border-[2px] border-solid border-[#FFA500]">
                            ...
                            <div className="anim_body">
                                <h4 className="text-[.8rem] w-full text-ellipsis m-auto text-center font-medium">Make Amazing
                                    Presentation</h4>
                                <p className="text-[.8rem] w-4/5 text-ellipsis m-auto text-center">Lorem ipsum dolor sit amet, consetetur</p>
                            </div>
                        </div>
                        ...
                        <div className="rounded_animation absolute top-[100px] left-[-80px] bg-[#FFFFF0] w-[200px] h-[200px] rounded-[100px] p-3 border-[2px] border-solid border-[#FFA500]">
                            ...
                            <div className="anim_body">
                                <h4 className="text-[.8rem] w-full text-ellipsis m-auto text-center font-medium">Host Classes
                                    with Libraries</h4>
                                <p className="text-[.8rem] w-4/5 text-ellipsis m-auto text-center">Lorem ipsum dolor sit amet, consetetur</p>
                            </div>
                        </div>
                        ...
                        <div className="rounded_animation absolute bottom-0 left-0 bg-[#FFFFF0] w-[200px] h-[200px] rounded-[100px] p-3 border-[2px] border-solid border-[#FFA500]">
                            ...
                            <div className="anim_body">
                                <h4 className="text-[.8rem] w-full text-ellipsis m-auto text-center font-medium">For Physical
                                    Presentations</h4>
                                <p className="text-[.8rem] w-4/5 text-ellipsis m-auto text-center">Lorem ipsum dolor sit amet, consetetur</p>
                            </div>
                        </div>
                        ...
                        <div className="rounded_animation absolute top-[100px] right-[-80px] bg-[#FFFFF0] w-[200px] h-[200px] rounded-[100px] p-3 border-[2px] border-solid border-[#FFA500]">
                            ...
                            <div className="anim_body">
                                <h4 className="text-[.8rem] w-full text-ellipsis m-auto text-center font-medium">For Business</h4>
                                <p className="text-[.8rem] w-4/5 text-ellipsis m-auto text-center">Lorem ipsum dolor sit amet, consetetur</p>
                            </div>
                        </div>
                        {/* ///////////////////////////////////////////////////// */}
            ...
            <div className="get_intouch bg-black text-white py-10">
                <div className="container">
                    ...
                    <div className="wrap_contacts w-full flex justify-between items-center flex-wrap maxScreenMobile:flex-col-reverse">
                        <div className="w-[50%] min-h-[30rem] text-[0.8rem] mb-10 maxScreenMobile:w-full">
                            ...
                            <p className="w-full mb-10">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut</p>
                            <form>
                                ...
                                <div className=" mb-8">
                                    <label htmlFor="message" className="block w-full ">Message</label>
                                    <textarea name="message" id="message" cols="auto" rows="auto" className="block w-full min-h-[5rem] bg-transparent border-b-[1px] border-solid border-white"></textarea>
                                </div>
                                <button type="submit" className="block w-[10rem] bg-[white] ml-auto text-black text-[.8rem] font-medium p-[.5rem] rounded-[2rem] maxScreenMobile:w-full">Submit</button>
                            </form>
                        </div>
                        <div className="w-2/5 min-h-[30rem] maxScreenMobile:w-full">
                            <div className="w-full mb-10">
                                <h4 className="mb-3">Call US</h4>
                                <p className="text-[0.8rem] mb-3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut</p>
                                <div className="flex items-center">
                                    <img src={callus} alt={callus} className="block w-5 h-5 mr-5" />
                                    <a href="tel:+2349117511763" className="text-[#FFA500]">+2349117511763</a>
                                </div>
                            </div>
                            ...
                            <div className="w-full mb-10">
                                ...
                                <p className="text-[0.8rem] mb-3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut</p>
                                <div className="flex items-center">
                                    <img src={location} alt={location} className="block w-5 h-5 mr-5" />
                                    <a href="/" className="text-[#FFA500]">Greece Nevada East Joanie 06918 Leonard Mission</a>
                                </div>
                            </div>
                            ...
                            <div className="w-full mb-10">
                                ...
                                <div className="flex items-center">
                                    <img src={location} alt={location} className="block w-5 h-5 mr-5" />
                                    <a href="sms:+2349117511763" className="text-[#FFA500]">SMS to +2349117511763</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container flex justify-between align-top maxScreenMobile:flex-col">
                    <div className="wrapAccurdion w-2/5 pr-5 maxScreenMobile:w-full">
                        ...
                        <h3 className="text-[3rem] font-black break-all leading-[4rem] maxScreenMobile:text-[2rem]">Frequently
                            ask
                            questions.</h3>
                    </div>
                    <div className="accurdion w-3/5 min-h-[50vh] maxScreenMobile:w-full">
                        {Array(4).fill(0).map((_, i) => ({ id: i })).map(({ id }) =>
                            <Accordion
                                key={id}
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae iusto provident neque. Nulla molestiae quam rerum velit fugiat labore, quia fugit obcaecati quo architecto officiis sit consectetur! Omnis, deserunt consequatur.</p>
                            </Accordion>
                        )}
                    </div>
                </div>
