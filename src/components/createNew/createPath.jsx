  ...
  return (
    <div className="bg-primaryTwo w-full !h-[100svh] !text-white flex flex-col justify-between maxScreenMobile:justify-start items-center">
      ...
      >
          ...
          <>
            ...
            <div className="w-fit h-fit grid grid-cols-2 gap-6 maxScreenMobile:grid-cols-1 maxScreenMobile:grid-rows-2 maxScreenMobile:w-full">
              ...
              >
                ...
                <button
                  htmlFor="file"
                  className="w-fit h-fit py-1 px-4 bg-primaryTwo border-[1px] border-white rounded-md flex justify-between items-center gap-2"
              ...
              <motion.div
                ...
                onClick={() =>
                  setCreate({ ...create, file: "", dontHave: !create.dontHave })
                }
              >
                <div>
                  <h6 className="text-md font-semibold text-center mb-2">
        ...
        <p
          className={`${isError ? "block font-bold text-[red] text-md w-full text-center absolute top-[105%]" : "hidden"}`}
        >
          {isError}
        </p>
      </section>
      ...
      <footer className="w-full h-fit pb-8 pt-3 maxScreenMobile:mt-auto maxScreenMobile:mb-0 maxScreenMobile:justify-self-end">
        <div className="container flex justify-between items-center">
          <button
            className={`${stage === 1 ? "hidden" : "block"} py-2 px-8 bg-primaryTwo border-[1px] border-white rounded-md`}
          ...
          <button
            ...
            onClick={() => IncrementDecrementStage("increment")}
          >
            Next
          </button>
        </div>
