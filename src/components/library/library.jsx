    ...
    return (<>
        ...
        <section className="library container py-5 min-h-screen bg-[#FFFFF0]">
            <div className="w-full mt-20 mb-10">
                {Array(7).fill(0).map((_, i) => ({ id: i })).map(({ id }) =>
                    <NavLink to={'/'} key={id}
                 ...
                 border-black rounded-[.6rem]
                    ...
                    justify-between items-center">
                        <div className="after_effect bg-transparent rounded-t-[.5rem] flex w-full justify-between items-center text-white pt-8 pb-4 px-2">
                            <span className="tracking-[.4rem] uppercase text-[1.005rem]">GNS</span>
                            <span className="tracking-[.4rem] uppercase text-[1.005rem]">LIBRARY</span>
                        </div>
                        <div className="w-full bg-[#FFFFF0] text-black px-2">
                            <h2 className="block text-4xl w-full font-bold my-4">GNS</h2>
                            <p className="block w-full my-1 text-[1.3rem] font-bold">Department of General Studies</p>
                            <p className="block w-full my-1 text-[1.1rem]">Abubakar Tafawa Balewa University Bauchi</p>
